...
class User extends \App\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', '' . "\0" . 'App\\Entity\\User' . "\0" . 'sessionId', '' . "\0" . 'App\\Entity\\User' . "\0" . 'forgotPassword', 'groups', '' . "\0" . 'App\\Entity\\User' . "\0" . 'orders', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'roles', '' . "\0" . 'App\\Entity\\User' . "\0" . 'createdAt', '' . "\0" . 'App\\Entity\\User' . "\0" . 'updatedAt', '' . "\0" . 'App\\Entity\\User' . "\0" . 'deletedAt'];
        }
     ...
     * {@inheritDoc}
     */
    public function setSessionId(?string $sessionId): \App\Entity\User
    {
    ...
    public function getForgotPassword(): ?string
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getForgotPassword', []);

        return parent::getForgotPassword();
    }

    /**
     * {@inheritDoc}
     */
    public function setForgotPassword(?string $forgotPassword): \App\Entity\User
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setForgotPassword', [$forgotPassword]);

        return parent::setForgotPassword($forgotPassword);
    }

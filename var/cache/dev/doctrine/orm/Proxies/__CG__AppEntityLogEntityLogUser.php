...
namespace Proxies\__CG__\App\Entity\LogEntity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class LogUser extends \App\Entity\LogEntity\LogUser implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (LogUser $proxy) {
